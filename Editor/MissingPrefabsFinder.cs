...
public class MissingPrefabsFinder {
	// Based on this post: https://forum.unity.com/threads/detecting-missing-nested-prefab.697562/
	...
	private static void FindMissingPrefabInGO(GameObject g, string prefabName, bool isRoot) {
